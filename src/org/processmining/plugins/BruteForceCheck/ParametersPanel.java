...
public class ParametersPanel extends JPanel {
	...
	public void getSettings(){
	    this.settings.put("setRelativeToBestThreshold",sliderValueFunction(doubleSlider1.getValue(), false) / 100d);
		this.settings.put("setL1lThreshold",sliderValueFunction(doubleSlider2.getValue(), false) / 100d);
		this.settings.put("setL2lThreshold",sliderValueFunction(logarithmicSlider1.getValue(), true) / 100d);
		this.settings.put("setLongDistanceThreshold",sliderValueFunction(logarithmicSlider2.getValue(), true) / 100d);
		this.settings.put("setAndThreshold",sliderValueFunction(doubleSlider3.getValue(), false) / 100d);
		this.settings.put("setUseAllConnectedHeuristics",this.t6.getValue() / 100d);
		this.settings.put("setUseLongDistanceDependency",this.c1.isSelected());
		this.settings.put("setCheckBestAgainstL2L",this.c3.isSelected());
		this.settings.put("setClassifier",classifiersPanel.eventClassComboBoxValue());
